...
#include "Ui/generatecomsolfiledialog.h"
    ...
    : QWidget(parent), _projectFile(projectFile)
{
    ...
    _generator = new GenerateComsolFileDialog(*_projectFile);
    createToolBar();
}
/*!
...
void Monofin::createToolBar()
{
    ...
    _actionSimplifyView->setIcon(QIcon(":/icons/drawing/simplifyView.png"));
