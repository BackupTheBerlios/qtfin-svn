...
void QtWindowListMenu::changeEvent(QEvent *e)
{
    switch (e->type()) {
...
void QtWindowListMenu::retranslateUi()
{
    setTitle(tr("&Windows"));
    const QList<QAction *> acts = stdGroup->actions();
    acts[CloseAction]->setText(tr("Cl&ose"));
    acts[CloseAction]->setStatusTip(tr("Close the active window"));
    acts[CloseAllAction]->setText(tr("Close &All"));
    acts[CloseAllAction]->setStatusTip(tr("Close all the windows"));
    acts[TileAction]->setText(tr("&Tile"));
    acts[TileAction]->setStatusTip(tr("Tile the windows"));
    acts[CascadeAction]->setText(tr("&Cascade"));
    acts[CascadeAction]->setStatusTip(tr("Cascade the windows"));
    acts[NextAction]->setText(tr("Ne&xt"));
    acts[NextAction]->setStatusTip(tr("Move the focus to the next window"));
    acts[PrevAction]->setText(tr("Pre&vious"));
    acts[PrevAction]->setStatusTip(tr("Move the focus to the previous window"));
}
