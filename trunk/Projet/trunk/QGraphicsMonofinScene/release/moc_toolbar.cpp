...
**
** Created: Tue 24. Mar 20:05:58 2009
...
static const char qt_meta_stringdata_ToolBar[] = {
    ...
    "activeAddPoint(bool)\0activateRemoveControl(bool)\0"
    "beginLine(bool)\0clean()\0finishedLine(bool)\0"
};
...
int ToolBar::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: activateRemoveControl((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 3: beginLine((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 4: clean(); break;
        case 5: finishedLine((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 6;
    }
