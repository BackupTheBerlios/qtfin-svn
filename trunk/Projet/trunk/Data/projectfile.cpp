...
namespace Data{
    ...
    float ProjectFile::getLayerMaxLength() const{
        return _monofinGeometry->getLayerMaxLength();
    }

    float ProjectFile::getLayerMaxHeight() const{
        return _monofinGeometry->getLayerMaxHeight();
    }
